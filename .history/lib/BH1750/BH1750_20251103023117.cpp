...
BH1750::BH1750(uint8_t address, TwoWire* wire)
...
bool BH1750::readRaw(uint16_t &out) {
    // Request 2 bytes
...
float BH1750::getLux() const {
    return _lastLux;
}

BH1750::Error BH1750::getLastError() const {
    return _lastError;
}

const char* BH1750::getErrorMessage() const {
    switch (_lastError) {
...
void BH1750::setContinuousHighRes(bool continuousHighRes) {
