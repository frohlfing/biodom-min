...
int CapacitiveSoilSensor::getRaw() const {
    return _lastRaw;
}

int CapacitiveSoilSensor::getPercent() const {
    return _lastPct;
}

void CapacitiveSoilSensor::setCalibration(int dryValue, int wetValue) {
    _dry = dryValue;
    _wet = wetValue;
}
